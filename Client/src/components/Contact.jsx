...
const Contact = () => {
  ...
  const socialLinks = [
    ...
    },
    {
      ...
      label: "Twitter",
      hoverClass: "hover:text-cyan-500 hover:bg-cyan-50",
    },
  ];
  ...
  return (
    <section className="min-h-screen relative bg-gradient-to-br from-slate-900 via-cyan-900 to-slate-900 py-20 px-6 overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-20">
          <div className="inline-block">
            <h2 className="text-6xl md:text-7xl font-bold bg-gradient-to-r from-white via-cyan-200 to-blue-200 bg-clip-text text-transparent mb-6 tracking-tight">
              Let's Connect
            </h2>
        ...
        <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
          ...
          <div className="xl:col-span-2">
            <div className="bg-gray-800/50 border-cyan-500/20 shadow-cyan-500/10 backdrop-blur-xl rounded-3xl border p-8 md:p-12 shadow-2xl hover:shadow-3xl transition-all duration-500 group">
              ...
              <div className="space-y-6">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  <div className="group">
                    <label className="block text-sm font-semibold text-gray-400 mb-3 group-focus-within:text-cyan-600 transition-colors">
                      Name
                    </label>
                    <input
                      type="text"
                      ...
                      className="w-full p-4 rounded-xl bg-gray-700/30 border-cyan-500/10 text-white placeholder-gray-400 border-2 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/20 transition-all duration-300"
                ...
                <div className="group">
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    rows={6}
                    className="w-full p-4 rounded-xl bg-gray-700/30 border-cyan-500/10 text-white placeholder-gray-400 border-2 focus:outline-none focus:border-cyan-500 focus:ring-4 focus:ring-cyan-500/20 transition-all duration-300 resize-none"
                    placeholder="Tell me about your project or just say hello!"
                  />
                </div>
                <button
                  onClick={handleSubmit}
                  className="w-full py-4 px-8 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-700 hover:to-blue-700 shadow-cyan-500/25 text-white rounded-xl font-semibold text-lg transition-all duration-300 shadow-lg hover:shadow-xl transform hover:-translate-y-1 active:translate-y-0 group"
                >
          ...
          <div className="space-y-8">
            {/* Contact Info */}
            <div className="bg-gray-800/50 border-cyan-500/20 shadow-cyan-500/10 backdrop-blur-xl rounded-3xl border p-8 shadow-2xl hover:shadow-3xl transition-all duration-500">
              ...
              <div className="space-y-4">
                {contactInfo.map((info, index) => (
                  <a
                    ...
                    className="flex items-start gap-4 p-4 rounded-xl hover:bg-cyan-600/10 transition-all duration-300 group"
                  >
                    <div className={`w-10 h-10 bg-gradient-to-r ${info.gradientClass} rounded-lg flex items-center justify-center text-white flex-shrink-0 group-hover:scale-110 transition-transform duration-300`}>
                      {info.icon}
                    </div>
                    <div>
              ...
              <div className="flex gap-4 justify-center">
                {socialLinks.map((social, index) => (
                  <a
                    ...
                    className="w-14 h-14 rounded-xl bg-gray-700/30 text-gray-400 hover:bg-cyan-600/20 hover:text-cyan-400 flex items-center justify-center text-xl transition-all duration-300 hover:scale-110 hover:shadow-lg transform"
            ...
            <div className="bg-gradient-to-br from-cyan-900/20 to-blue-900/20 border-cyan-500/20 backdrop-blur-xl rounded-3xl border p-8 text-center">
